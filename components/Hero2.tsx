  ...
  return (
    <div className='bg-[#EEEEF0] h-full lg:h-screen text-[#002F69] pb-10'>
        ...
        <div className="flex items-center justify-end right-0 px-10 text-balance pt-10 lg:pt-20 ml-0 lg:ml-80">
            <p className='text-lg'>Write a paragraph that talks about your company here. You can talk about your companys background, history, mission, vision, or philosophy. Anything that will introduce your brands persona to your clients. This will help build a connection between you and them, that hopefully leads to a working relationship.</p>
        </div>
